...
namespace Marketer.Infrastructure.EfCore.Migrations
{
    ...
    [Migration("20220510100705_makeTypeValueToString")]
    partial class makeTypeValueToString
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketer.Domain.Entities.Products.PackageType", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Marketer.Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.Property<string>("PackageValue")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Marketer.Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.HasOne("Marketer.Domain.Entities.Products.PackageType", "PackageType")
                        .WithMany("Products")
